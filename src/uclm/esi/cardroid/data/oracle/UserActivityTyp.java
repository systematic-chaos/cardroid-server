...
public class UserActivityTyp implements ORAData, ORADataFactory {
	...
	static {
		...
		_factory[1] = TripOffer.getORADataFactory();
	}
	protected static final UserActivityTyp _UserActivityTypFactory = new UserActivityTyp();
	...
	public UserActivityTyp(User activityUser, TripOffer activityTrip,
			String activityType, java.sql.Timestamp timeStamp)
			throws SQLException {
		_init_struct(true);
	...
	protected ORAData create(UserActivityTyp o, Datum d, int sqlType)
			throws SQLException {
		if (d == null)
			return null;
		if (o == null)
	...
	public TripOffer getActivityTrip() throws SQLException {
		return (TripOffer) _struct.getAttribute(1);
	}

	public void setActivityTrip(TripOffer activityTrip) throws SQLException {
	...
	public String toString() {
		try {
			return "ANDROID.USER_ACTIVITY_TYP"
					+ "("
					+ getActivityUser()
					+ ","
					+ getActivityTrip()
