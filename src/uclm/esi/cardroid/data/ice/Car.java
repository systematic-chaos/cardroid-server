...
public class Car extends CarTyp implements ICar, ObjectFactory {
	 ...
	 * Default constructor
	 */
	public Car(String brand, String model, uclm.esi.cardroid.data.zerocice.Fuel carFuel,
	 ...
	 */
	public static CarTypPrx createProxy(String ownerEmail, CarTyp carObject,
			ObjectAdapter adapter) {
		CarTypPrx carPrx = CarTypPrxHelper.uncheckedCast(adapter
				.createProxy(createIdentity(carObject.getPlate(), ownerEmail)));
	 ...
	 * 			servant is added to adapter 's active servant map
	 */
	public static CarTypPrx createProxy(String ownerEmail, ICar carObject,
			ObjectAdapter adapter) {
		CarTypPrx carPrx = CarTypPrxHelper.uncheckedCast(adapter
				.createProxy(createIdentity(carObject.getPlate(), ownerEmail)));
		fillProxyData(carObject, carPrx, adapter);
	 ...
	 * in the given object
	 */
	public static void fillProxyData(CarTyp object, CarTypPrx proxy,
			ObjectAdapter adapter) {
	 ...
	 * in the given object
	 */
	public static void fillProxyData(ICar object, CarTypPrx proxy,
			ObjectAdapter adapter) {
		proxy.setBrand(object.getBrand());
		proxy.setModel(object.getModel());
		proxy.setCarFuel(uclm.esi.cardroid.data.zerocice.Fuel.valueOf(object.getFuel()
				.name()));
		proxy.setConsumptionPerKm(object.getConsumptionPerKm());
		proxy.setNSeats(object.getNSeats());
		proxy.setColor(object.getColor());
